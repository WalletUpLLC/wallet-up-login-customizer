...
class WalletUpSafeActivation {
    ...
    public static function activate() {
        ...
        if (false === get_option('wallet_up_login_customizer_security_options')) {
            update_option('wallet_up_login_customizer_security_options', $safe_defaults);
        }
    ...
    public static function deactivate() {
        ...
        global $wpdb;
        $wpdb->query($wpdb->prepare("DELETE FROM {$wpdb->options} WHERE option_name LIKE %s", '_transient_wallet_up%'));
